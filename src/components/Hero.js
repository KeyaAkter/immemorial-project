...
const Hero = () => {
  // Creating Reference for hero texts
  const heroRef = useRef(null);
  const shutter1 = useRef(null);
  const shutter2 = useRef(null);

  // Creating Reference for hero images
  ...
  // Calling custom hooks for animating hero texts
  useGsapShutterUnveil(shutter1, 0, heroRef);
  useGsapShutterUnveil(shutter2, 0.2, heroRef);

  // Calling custom hooks for animating hero images
